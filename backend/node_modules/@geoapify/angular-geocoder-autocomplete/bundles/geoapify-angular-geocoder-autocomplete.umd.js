(function (global, factory) {
    ...
    GeocoderAutocompleteComponent.propDecorators = {
        ...
        debounceDelay: [{ type: core.Input }],
        preprocessingHook: [{ type: core.Input }],
        postprocessingHook: [{ type: core.Input }],
        suggestionsFilter: [{ type: core.Input }],
